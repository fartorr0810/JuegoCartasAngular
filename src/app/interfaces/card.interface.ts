...
const typeMap: any = {
  ...
  "Datum": o([
      ...
      { json: "retreatCost", js: "retreatCost", typ: a(r("Cost")) },
  ...
  "Attack": o([
      { json: "name", js: "name", typ: "" },
      { json: "cost", js: "cost", typ: a(r("Cost")) },
  ...
  "Prices": o([
      { json: "holofoil", js: "holofoil", typ: u(undefined, r("Holofoil")) },
      { json: "reverseHolofoil", js: "reverseHolofoil", typ: u(undefined, r("Holofoil")) },
      { json: "normal", js: "normal", typ: u(undefined, r("Holofoil")) },
  ], false),
  "Holofoil": o([
